...
export const orgInfo = new OrganizationServices().getOrganizationInfo();

## Anti-Harassment Policy

{orgInfo.name} (GDG) is dedicated to providing a harassment-free and inclusive event experience for everyone regardless of gender identity and expression, sexual orientation, disabilities, neurodiversity, physical appearance, body size, ethnicity, nationality, race, age, religion, or other protected category. We do not tolerate harassment of event participants in any form. GDG{" "} {orgInfo.name} takes violations of our policy seriously and will respond appropriately.  
  
All participants of GDG {orgInfo.name} events must abide by the following policy:
...
Harassment is not tolerated. We have a zero tolerance policy for in-person or online harassment of any kind, including but not limited to:
...
All participants of GDG {orgInfo.name} events, including in-person and online attendees, event staff, speakers, and Googlers, must abide by this policy. Zero tolerance policy applies to harassment of any kind, in relation to, but not limited to:
...
Participants asked to stop any harassing behavior are expected to comply immediately. This policy extends to talks, forums, workshops, codelabs, social media, parties, hallway conversations, all attendees, partners, sponsors, volunteers, event staff, etc. You catch our drift. GDG{" "} {orgInfo.name} reserves the right to refuse admittance to, or remove any person from, any GDG{" "} {orgInfo.name} hosted event (including future GDG{" "} {orgInfo.name} events) at any time in its sole discretion. This includes, but is not limited to, attendees behaving in a disorderly manner or failing to comply with this policy, and the terms and conditions herein. If a participant engages in harassing or uncomfortable behavior, the event organizers may take any action they deem appropriate, including warning or expelling the offender from the event with no refund.
...
You can make a report either personally to {orgInfo.conferenceEmail} or anonymously on {orgInfo.codeOfConductReportFormLink}. 
